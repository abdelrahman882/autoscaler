...
func TestBufferGenerationFilter(t *testing.T) {
	tests := []struct {
		name                       string
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			bufferGenerationFilter := &bufferGenerationFilter{
				buffersGenerations: test.cachedBufferGenerations,
			}
			filtered, filteredOut := bufferGenerationFilter.Filter(test.buffers)
...
func TestBufferGenerationFilterCaching(t *testing.T) {
	tests := []struct {
		name                       string
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			bufferGenerationFilter := NewBufferGenerationFilter()
			for index, buffers := range test.buffersIterations {
				filtered, filteredOut := bufferGenerationFilter.Filter(buffers)
