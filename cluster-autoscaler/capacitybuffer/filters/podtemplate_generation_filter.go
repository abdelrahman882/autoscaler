...
func NewPodTemplateGenerationFilter(client kubernetes.Interface) *podTemplateGenerationFilter {
...
func (f *podTemplateGenerationFilter) podTemplateGenerationChanged(buffer *v1.CapacityBuffer) bool {
	...
	podTemplate, err := common.GetPodTemplate(f.client, buffer.Status.PodTemplateRef.Name)
	if err != nil {
