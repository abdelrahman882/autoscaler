...
func TestClientGetPodTemplate(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			fakeCapacityBuffersClient, _ := NewCapacityBufferClientFromClients(fakeBuffersClient, fakeKubernetesClient)
			pt, err := fakeCapacityBuffersClient.GetPodTemplate(test.objectName)
